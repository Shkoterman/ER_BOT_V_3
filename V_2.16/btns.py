...
my_main_menu_markup.add(myregistrationbtn, regoneventbtn, sendfeedbackbtn, allaoboutsubscriptionbtn, paybtn, cancel, askqbtn, olivebtn, sendreminderbtn, askfeedbackbtn, pingbtn, testbtn)
