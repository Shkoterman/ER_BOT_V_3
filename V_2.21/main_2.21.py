...
def registration_step_4(message, for_reg_dickt):
    if message.text == btns.backbtn.text or message.text == btns.mainmenubtn.text:
        main_menu(message, 0)
    ...
    if message.text == btns.mainmenubtn.text:
        ...
        try:
            ...
            if ol_amount==0:
                ...
                markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
                markup.add(btns.backbtn, btns.olive_got_it1)
...
def olive_step_3(message, olive_tuple, ol_amount):
    if message.text == btns.backbtn.text:
        ...
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        markup.add(btns.backbtn, btns.olive_got_it2)
